...
User <|-- Admin : extendsChallenge <|-- ManualChallenge : extends
Challenge <|-- CodeforcesChallenge : extendsIAuthService <|.. User : realizesStudent "1" --> "0..*" Submission : submits
Student "0..*" --> "0..*" Classroom : joins
Student "1" --> "0..*" Badge : earns
Student "0..*" --> "1" Leaderboard : ranked inTeacher "1" --> "0..*" Classroom : createsChallenge "1" *-- "0..*" Submission : composed of
ManualChallenge "1" *-- "1..*" TestCase : containsAdmin ..> Challenge : manages
